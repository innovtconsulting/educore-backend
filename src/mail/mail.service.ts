...
export class MailService {
  ...
  async sendMail(to: string, subject: string, html: string, options?: { fromName?: string }) {
  ...
  async sendPasswordResetEmail(to: string, token: string, etablissementName?: string) {
    ...
    `;
    return this.sendMail(to, subject, html, { fromName: `${schoolName} Administration` });
  }
}
