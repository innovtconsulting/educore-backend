...
export class CreateClasseDto {
  ...
  @ApiProperty({ example: [1, 2], description: "Liste des IDs des niveaux (ex: L1, L2)" })
  ...
  @ApiProperty({ example: [1], description: "Liste des IDs des établissements" })
  @IsArray({ message: 'Les établissements doivent être fournis sous forme de tableau' })
  @ArrayNotEmpty({ message: 'Au moins un établissement est obligatoire' })
  @IsNumber({}, { each: true, message: 'Chaque ID d établissement doit être un nombre' })
